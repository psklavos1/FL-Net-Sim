  ...
  while (!isParsingComplete ())
    {
      ...
      switch (parsedElement.type)
        ...
        case XML_WPACKET_RX_REF:
        {
          ...
          // we need to fall through here to get an animation event for the wireless packet
          // otherwise we get no wireless circles.  looks like it broke between 3.108 and 3.109
          //break;
        }
        case XML_WPACKET_RX:
        case XML_PACKET_RX:
